...
#include "Commands/CommandGroup2.h"
...
#include "Commands/TargetManual.h"
...
OI::OI() {
	...
	manualTarget = new JoystickButton(operatorStick, 8);
	manualTarget->WhenPressed(new TargetManual());
	...
	SmartDashboard::PutData("TargetManual", new TargetManual());
