...
OI::OI() {
	...
	shiftDownButton = new JoystickButton(driveController, 11);
	shiftDownButton->WhenPressed(new DownShift());
	shiftUpButton = new JoystickButton(driveController, 12);
	shiftUpButton->WhenPressed(new UpShift());
	collectorIntake = new JoystickButton(driveController, 2);
	collectorIntake->WhileHeld(new CollectorLoad());
	collectorSpit = new JoystickButton(driveController, 3);
	...
	downCollector->WhileHeld(new Collect());
	upCollector = new JoystickButton(driveController, 5);
	upCollector->WhileHeld(new CollectorUP());
	downShift = new JoystickButton(driveController, 11);
	downShift->WhileHeld(new DownShift());
	operatorStick = new Joystick(3);
	
	autoTargetButton = new JoystickButton(operatorStick, 8);
	autoTargetButton->WhileHeld(new AutoTarget());
	...
	alsoCollectorDown->WhileHeld(new CollectorLoad());
    ...
    controlChooser->AddDefault("Controller", (void *)true);
    controlChooser->AddObject("Joysticks", (void *)false);
}
