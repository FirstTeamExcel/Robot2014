...
public:
    typedef enum {LOAD,EJECT,LONG_GOAL,SHORT_GOAL,REVERSE_SHORT_GOAL,TRUSS,LONG_TRUSS,AUTONOMOUS_1,AUTONOMOUS_2,AUTONOMOUS_3,AUTONOMOUS_CLOSE, CATCH, CUSTOM}ShooterArmPosition;
 private:
	float _targetAngle;
	float _bothStage_P;
    float _stage_1_I;
