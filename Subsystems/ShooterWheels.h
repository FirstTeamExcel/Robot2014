...
public:
    ...
    void SetTargetRpm(float targetRpm, bool absoluteTolerance = false, float tolerance = SPEED_TOLERANCE);
	void SetTargetRpm(float targetRpm, float upperLimitRpm, float lowerLimitRpm);
