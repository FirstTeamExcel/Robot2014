...
ShooterArm::ShooterArm() :
    PIDSubsystem("ShooterArm", 1.0, 0.0, 0.0)
{
    SetAbsoluteTolerance(0.2);
    GetPIDController()->SetContinuous(false);
    LiveWindow::GetInstance()->AddActuator("ShooterArm",
...
double ShooterArm::ReturnPIDInput()
{
    ...
    float angle = VOLTAGE_TO_DEGREES(shooterArmPot->GetAverageVoltage());
...
float ShooterArm::PIDOutputToMotorCommand(double output)
{
    ...
    if (output > 0)
    {
        return output + (output * cos(currentAngle));
