...
#define TARGET_SHORT_GOAL_SPEED (1400)
#define TARGET_AUTONOMOUS_1_SPEED (3100)
#define TARGET_AUTONOMOUS_2_SPEED (3100)
#define TARGET_AUTONOMOUS_3_SPEED (3100)
#define TARGET_AUTONOMOUS_CLOSE_SPEED (2600)

#define TARGET_TRUSS_SPEED (2000)
#define TARGET_TRUSS_POWER (0.65)
