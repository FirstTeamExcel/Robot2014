...
void RobotMap::init() {
	...
	driveSubsystemleftRearDrive = new Talon(1, 2);
	lw->AddActuator("DriveSubsystem", "leftRearDrive", (Talon*) driveSubsystemleftRearDrive);
	
	driveSubsystemleftFrontDrive = new Talon(1, 1);
	lw->AddActuator("DriveSubsystem", "leftFrontDrive", (Talon*) driveSubsystemleftFrontDrive);
	
	driveSubsystemrightFrontDrive = new Talon(1, 3);
	lw->AddActuator("DriveSubsystem", "rightFrontDrive", (Talon*) driveSubsystemrightFrontDrive);
	
	driveSubsystemrightRearDrive = new Talon(1, 4);
	lw->AddActuator("DriveSubsystem", "rightRearDrive", (Talon*) driveSubsystemrightRearDrive);
